...
export default function ProjectsPage() {
    return (
        <div className="flex flex-col md:h-screen lg:items-center lg:justify-center lg:h-[calc(100vh - 3.5rem)]">
            ...
            <main className="mt-4 mx-4 lg:mt-16 flex flex-col gap-8 lg:flex-row lg:gap-16 justify-center items-center">
